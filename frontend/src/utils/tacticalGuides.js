...
export const TACTICAL_GUIDES = {
  ...
  // Support Range
  'support_range': 'هرچه بیشتر باشد بازیکنان میل کمتری به دریافت پاس دارند و با فاصله بیشتری از هم بازی میکنند',
  ...
  'محافظه کار': 'اولین مدافع با نگه داشتن مهاجمين حريف در بازوها بجای در گیر شدن، آن ها را متوقف خواهد كرد و ریسک کم می شود.',
  'aggressive': 'اولین دفاع وارد عمل میشه و مهاجم های حريف رو ميبنده تا توپ رو برگردونه.',
  'conservative': 'اولین مدافع با نگه داشتن مهاجمين حريف در بازوها بجای در گیر شدن، آن ها را متوقف خواهد كرد و ریسک کم می شود.',
