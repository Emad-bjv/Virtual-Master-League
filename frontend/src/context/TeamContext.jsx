...
export const resolveFormationKey = (form) => {
  ...
  if (form === '4-4-2' || form.startsWith('4-4-2')) {
    if (form.includes('4-3-1-2')) return '4-4-2 (4-3-1-2)';
    return '4-4-2 (4-2-2-2)';
  }
  if (form === '3-5-2' || form.startsWith('3-5-2')) {
    if (form.includes('3-3-2-2')) return '3-5-2 (3-3-2-2)';
    return '3-5-2 (3-2-3-2)';
  }
