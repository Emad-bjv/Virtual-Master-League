...
import { 
  ...
  FileText, Database, LogOut, ExternalLink, ArrowRight, Newspaper, Gift, ArrowRightLeft, Sparkles 
} from 'lucide-react';
    ...
    <div className="admin-portal" style={{fontFamily: 'Vazirmatn, Tahoma, sans-serif'}}>
      <aside className="admin-sidebar glass-panel" style={{ borderRadius: 0, borderTop: 0, borderBottom: 0, borderRight: 0 }}>
        ...
        <nav className="admin-nav">
          ...
          <Link to="/admin/pes-skills" className={`admin-nav-link ${isActive('/admin/pes-skills')}`}>
