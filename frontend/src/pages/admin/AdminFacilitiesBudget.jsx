...
const AdminFacilitiesBudget = () => {
  ...
  const handleAdjustBudget = async (e) => {
    ...
    try {
      const headers = { Authorization: `Bearer ${localStorage.getItem('access_token')}` };
      await axios.post('/api/teams/admin_adjust_budget/', {
  ...
  const handleOverrideFacility = async (e) => {
    ...
    try {
      const headers = { Authorization: `Bearer ${localStorage.getItem('access_token')}` };
      await axios.post('/api/teams/admin_override_facility/', {
  ...
  const handleRegisterCoach = async (e) => {
    ...
    try {
      const headers = { Authorization: `Bearer ${localStorage.getItem('access_token')}` };
      await axios.post('/api/teams/admin_register_coach/', newCoachForm, { headers });
